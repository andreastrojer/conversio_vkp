    ...
    <AccountMenuClient
      ...
      logoutControl={
        <LogoutButton
          ...
          className="inline-flex h-9 w-full items-center justify-between gap-3 rounded-full border border-[#d9dcdf] bg-white px-4 font-sans text-[13px] font-medium tracking-[0.01em] text-[#3d4248] transition hover:border-[#efb804] hover:bg-[#fff8df] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3d4248] [@media(min-width:768px)_and_(max-width:1366px)]:h-[44px] [@media(min-width:768px)_and_(max-width:1366px)]:px-[20px] [@media(min-width:768px)_and_(max-width:1366px)]:text-[15px]"
