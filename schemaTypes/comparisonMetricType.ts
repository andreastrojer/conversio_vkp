...
export const comparisonMetricType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          { title: 'Jahresverbrauch', value: 'jahresverbrauch' },
          { title: 'Speichergröße', value: 'speichergroesse' },
          { title: 'Ladesstation', value: 'ladestation' },
          { title: 'Autarkiegrad', value: 'autarkiegrad' },
          { title: 'Investition', value: 'investition' },
